...
const ICONS = [
    ...
    },
    {
        id: 'DatabaseDark',
        label: 'Database (Dark)',
        image: require('@/assets/icon-db-dark.png'),
    },
    {
        id: 'DatabaseLight',
        label: 'Database (Light)',
        image: require('@/assets/icon-db-light.png'),
    },
    {
        id: 'Gopher',
        label: 'Gopher',
        image: require('@/assets/icon-gopher.png'),
    },
] as const
                ...
                {ICONS.map((icon, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isSelected && (
                                <Ionicons name="checkmark" size={24} color={COLORS.info} />
                            )}
                        </TouchableOpacity>
                    )
                })}
